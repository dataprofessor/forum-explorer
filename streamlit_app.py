...
with st.expander('About this app'):
  ...
  st.warning('To use the app, firstly enter an input query. The app will perform processing and generate a list of relevant forum posts based on K-means nearest neighbor search. Additionally, ')
